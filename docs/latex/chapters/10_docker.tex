...
\begin{enumerate}
  \item Clone the DALI repo from \url{https://github.com/AAAI-DISIM-UnivAQ/DALI}, 
  checkout the commit to an older version just to be sure that everything works 
  correctly as in mine setup, then navigate to the \texttt{DALI/Examples} folder.
  \begin{lstlisting}[language=bash, numbers=none]
  git checkout 255abcac25db7fe43fdbf7945656240bd61d25f2
  \end{lstlisting}
  \item Clone the GitHub repo project from \url{https://github.com/Mik1810/f1_race} under \texttt{Examples} folder.
\end{enumerate}
